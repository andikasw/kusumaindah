...
<?php 
$id = @$_GET['id'];
$sqluser = mysqli_query($mysqli,"SELECT * FROM tb_trip2 WHERE idtrip = '$id' ") or die (mysqli_error($mysqli));
    ...
    <div class="u-form u-form-1">
      <form action="" method="POST" enctype="multipart/form-data" class="u-clearfix u-form-spacing-15 u-inner-form" style="padding: 15px;" source="custom" name="form">
        <div class="u-form-group u-form-name u-form-group-1">
          ...
          <input type="text" placeholder="Title" id="name-6797" name="title" value="<?=$datauser['title']?>" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="" >
        </div>
        ...
        <div class="u-form-group u-form-group-3">
          ...
          <input type="text" placeholder="Price" id="text-4036" name="price" value="<?=$datauser['price']?>" class="u-border-1 u-border-grey-30 u-input u-input-rectangle">
        </div>
...
if(isset($_POST['edit'])){
  ...
  if (move_uploaded_file($jbt, $path)) {
    # code...
    mysqli_query($mysqli, "UPDATE tb_trip2 SET image = '$mmk', title = '$title', price = '$price', info1 = '$info1', info2 = '$info2' WHERE idtrip = '$id'") or die (myqli_error($mysqli)) ;
