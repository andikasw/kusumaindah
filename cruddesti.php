...
if(isset($_SESSION['user'])){
  ...
  <head>
    ...
    <title>Upload Destination</title>
    ...
    <link rel="stylesheet" href="<?=base_url()?>/css/Page-destination-crud.css" media="screen">
    ...
    <meta property="og:title" content="Page destination crud">
...
<section class="u-align-center u-clearfix u-grey-10 u-section-1" id="sec-c524">
  <div class="u-clearfix u-sheet u-sheet-1">
    <div class="u-palette-1-light-1 u-shape u-shape-rectangle u-shape-1"></div>
    <h1 class="u-custom-font u-font-arial u-text u-text-1">Upload Destination</h1>
    <div class="u-form u-form-1">
      <form action="" method="POST" enctype="multipart/form-data" class="u-clearfix u-form-spacing-15  u-inner-form" style="padding: 15px;" source="custom" name="form">
        ...
        <div class="u-form-group u-form-select u-form-group-3">
          <label for="select-3a00" class="u-form-control-hidden u-label">Select</label>
          <div class="u-form-select-wrapper">
            <select id="select-3a00" name="display" class="u-border-1 u-border-grey-30 u-input u-input-rectangle">
...
<section class="u-align-center u-clearfix u-grey-10 u-section-2" id="sec-33ef">
  <div class="u-clearfix u-sheet u-sheet-1">
    <div class="u-expanded-width u-table u-table-responsive u-table-1">
      <table class="u-table-entity u-table-entity-1">
        ...
        $no = 1;
        $sqluser = "SELECT * FROM tb_desti ORDER BY dte DESC LIMIT $posisi, $batas";
        $sqldata = mysqli_query($mysqli, $sqluser) or die (mysqli_error($mysqli));
        $queryJml ="SELECT * FROM tb_desti";
        $no = $posisi + 1;
          ...
          { 
            ...
            <tbody class="u-table-body">
              <tr style="height: 82px;">
                ...
                <td class="u-border-1 u-border-grey-30 u-table-cell"><a href="editdesti.php?id=<?=$datauser['iddesti']?>" class="u-btn u-btn-submit u-button-style u-gradient u-none u-btn-1"><span class="u-file-icon u-icon u-icon-1"><img src="images/edit.png" alt=""></span></a><a onClick="return confirm('Apakah Anda Yakin Ingin Menghapus?')" href="m1.php?id=<?=$datauser['iddesti']?>" class="u-btn u-btn-submit u-button-style u-gradient u-none u-btn-1"><span class="u-file-icon u-icon u-icon-2"><img src="images/delete.png" alt=""></span></a>
                </td>
              </tr>
            </tbody>
            <?php
...
if(isset($_POST['submit'])){
  ...
  if (move_uploaded_file($jbt, $path)) {
    ...
    $sqli = mysqli_query($mysqli, "INSERT INTO tb_desti (iddesti, title, display, image, info, dte) VALUES ('$uuid', '$title', '$display', '$mmk', '$info', '$tgl')")or die(mysql_error($mysqli));
    echo "<script>alert('Data berhasil di tambahkan!');window.location='cruddesti.php';</script>";
  }
  else {
 echo "<script>alert('Data gagal di tambahkan!');window.location='cruddesti.php';</script>";
