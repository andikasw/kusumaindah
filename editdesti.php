...
<body class="u-body"><header class="u-clearfix u-header u-image u-header" id="sec-6faf" data-image-width="1600" data-image-height="1067"><div class="u-clearfix u-sheet u-sheet-1">
...
$id = @$_GET['id'];
$sql_tambah = mysqli_query($mysqli, "SELECT * FROM tb_desti WHERE iddesti = '$id' ") or die (mysqli_error());
$datauser = mysqli_fetch_array($sql_tambah);
...
<section class="u-align-center u-clearfix u-grey-10 u-section-1" id="sec-635d">
  <div class="u-clearfix u-sheet u-sheet-1">
    ...
    <h1 class="u-custom-font u-font-arial u-text u-text-1">Update Destination</h1>
    <div class="u-form u-form-1">
      <form action="" enctype="multipart/form-data" method="POST" class="u-clearfix u-form-spacing-15  u-inner-form" style="padding: 15px;" source="custom" name="form">
        <div class="u-form-group u-form-name u-form-group-1">
          ...
          <input type="text" placeholder="" value="<?=$datauser['title']?>" id="name-6797" name="title" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="" autofocus="autofocus">
        </div>
        <div class="u-form-group u-form-group-2">
          <label for="email-6797" class="u-form-control-hidden u-label"></label>
          <input type="file" placeholder="Image" id="email-6797" name="image"  class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="" >
        </div>
        <div class="u-form-group u-form-select u-form-group-3">
          <label for="select-8dad" class="u-form-control-hidden u-label">Select</label>
          <div class="u-form-select-wrapper">
            <select id="select-8dad" name="display" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="">
        ...
        <div class="u-form-group u-form-message u-form-group-4">
          ...
          <textarea placeholder="Information" rows="4" cols="50" id="message-6797" name="info" class="u-border-1 u-border-grey-30 u-input u-input-rectangle ckeditor" required=""><?=$datauser['info']?></textarea>
        </div>
...
if(isset($_POST['submit'])){
  ...
  if (move_uploaded_file($jbt, $path)) {
    # code...
    mysqli_query($mysqli, "UPDATE tb_desti SET image = '$mmk', info = '$info', title = '$title', display = '$display' WHERE iddesti = '$id'") or die (myqli_error($mysqli)) ;
    echo "<script>alert('Data berhasil di ubah!');window.location='cruddesti.php';</script>";
