...
$id = @$_GET['id'];
$sql_tambah = mysqli_query($mysqli, "SELECT * FROM tb_news WHERE idnews = '$id' ") or die (mysqli_error());
...
?>
    <section class="u-align-center u-clearfix u-grey-10 u-section-1" id="sec-635d">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <h1 class="u-custom-font u-font-arial u-text u-text-1">Edit News</h1>
        <div class="u-form u-form-1">
          <form action="" enctype="multipart/form-data" method="POST" class="u-clearfix u-form-spacing-15  u-inner-form" style="padding: 15px;" source="custom" name="form">
            <div class="u-form-group u-form-name u-form-group-1">
              ...
              <input type="text" placeholder="Title" id="name-6797" name="title" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="" autofocus="autofocus" value="<?=$datauser['title']?>">
            </div>
...
$id = @$_GET['id'];
 ...
 if (move_uploaded_file($jbt, $path)) {
    # code...
  mysqli_query($mysqli, "UPDATE tb_news SET image = '$mmk', info = '$info', title = '$title' WHERE idnews = '$id'") or die (myqli_error($mysqli)) ;
  echo "<script>alert('Data berhasil di ubah!');window.location='crudnews.php';</script>";
