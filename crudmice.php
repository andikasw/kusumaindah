...
if(isset($_SESSION['user'])){
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?=base_url()?>/css/Page-rental-crud.css" media="screen">
    ...
    <meta property="og:title" content="Page rental crud">
...
<?php 
$sqluser = mysqli_query($mysqli,"SELECT * FROM tb_mice ") or die (mysqli_error($mysqli));
...
<section class="u-align-center u-clearfix u-grey-10 u-section-1" id="sec-e1f0">
  <div class="u-clearfix u-sheet u-sheet-1">
    ...
    <h1 class="u-custom-font u-font-arial u-text u-text-1">Upload KITA</h1>
  ...
  <div class="u-clearfix u-sheet u-sheet-1">
    <div class="u-expanded-width u-table u-table-responsive u-table-1">
      <table class="u-table-entity u-table-entity-1">
        ...
        $no = 1;
        $sqluser = "SELECT * FROM tb_mice1 ORDER BY dte DESC LIMIT $posisi, $batas";
        $sqldata = mysqli_query($mysqli, $sqluser) or die (mysqli_error($mysqli));
        $queryJml ="SELECT * FROM tb_mice1";
        $no = $posisi + 1;
          ...
          { 
            ...
            <tbody class="u-table-body">
              <tr style="height: 83px;">
                ...
                <td class="u-border-1 u-border-grey-30 u-table-cell"><a href="editmice.php?id=<?=$datauser['idmice']?>" class="u-btn u-btn-submit u-button-style u-gradient u-none u-btn-1"><span class="u-file-icon u-icon u-icon-1"><img src="images/edit.png" alt=""></span></a><a onClick="return confirm('Apakah Anda Yakin Ingin Menghapus?')" href="m6.php?id=<?=$datauser['idmice']?>" class="u-btn u-btn-submit u-button-style u-gradient u-none u-btn-1"><span class="u-file-icon u-icon u-icon-2"><img src="images/delete.png" alt=""></span></a>
                </td>
              </tr>
            </tbody>
            <?php
...
if(isset($_POST['edit'])){
  ...
  if (move_uploaded_file($jbt, $path)) {
    # code...
    mysqli_query($mysqli, "UPDATE tb_mice SET image = '$mmk', info1 = '$info1', info2 = '$info2', info3 = '$info3' WHERE id = '0'") or die (myqli_error($mysqli)) ;
    echo "<script>alert('Data berhasil di ubah!');window.location='crudmice.php';</script>";
  ...
  if (move_uploaded_file($jbt, $path)) {
    # code...
    mysqli_query($mysqli, "INSERT INTO tb_mice1  (idmice, image, info1, info2, title, price, dte) VALUES ('$uuid', '$mmk', '$info1', '$info2', '$title', '$price', '$tgl')") or die (myqli_error($mysqli)) ;
    echo "<script>alert('Data berhasil di tambahkan!');window.location='crudmice.php';</script>";
  }
}
?>