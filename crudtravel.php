...
if(isset($_SESSION['user'])){
  ...
  <head>
    ...
    <title>Upload Travel Reguler</title>    
    ...
    <link rel="stylesheet" href="<?=base_url()?>/css/Page-travel-crud.css" media="screen">
    ...
    <meta property="og:title" content="Page travel crud">
...
<?php 
$sqluser = mysqli_query($mysqli,"SELECT * FROM tb_travel1 ") or die (mysqli_error($mysqli));
$datauser = mysqli_fetch_array($sqluser);
?> 
<section class="u-align-center u-clearfix u-grey-10 u-section-1" id="sec-e1f0">
  <div class="u-clearfix u-sheet u-sheet-1">
    <div class="u-palette-1-light-1 u-shape u-shape-rectangle u-shape-1"></div>
    <h1 class="u-custom-font u-font-arial u-text u-text-1">Upload Travel</h1>
    <div class="u-form u-form-1">
      <form action="" enctype="multipart/form-data" method="POST" class="u-clearfix u-form-spacing-15  u-inner-form" style="padding: 15px;" source="custom" name="form">
        <div class="u-form-group u-form-group-1">
          ...
          <input type="file" placeholder="Image" id="email-6797" name="image" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="" autofocus="">
        </div>
        <div class="u-form-group u-form-message u-form-group-2">
          ...
          <textarea placeholder="Rent Car" rows="4" cols="50" id="message-6797" name="info1" class="u-border-1 u-border-grey-30 u-input u-input-rectangle ckeditor" required=""><?=$datauser['info1']?></textarea>
        </div>
        <div class="u-form-group u-form-group-3">
          <label for="textarea-4d67" class="u-form-control-hidden u-label"></label>
          <textarea placeholder="Value" rows="4" cols="50" id="textarea-4d67" name="info2" class="u-border-1 u-border-grey-30 u-input u-input-rectangle ckeditor" required="required"><?=$datauser['info2']?></textarea>
        </div>
        <div class="u-form-group u-form-group-4">
          <label for="textarea-8a4f" class="u-form-control-hidden u-label"></label>
          <textarea placeholder="Terms &amp; Conditions" rows="4" cols="50" id="textarea-8a4f" name="info3" class="u-border-1 u-border-grey-30 u-input u-input-rectangle ckeditor"><?=$datauser['info3']?></textarea>
        </div>
        <div class="u-align-left u-form-group u-form-submit u-form-group-5">
          <input type="submit" value="Submit" name="edit" class="u-btn u-btn-submit u-button-style u-gradient u-none u-btn-1 ">
        </div>
...
<section class="u-align-center u-clearfix u-grey-10 u-section-2" id="sec-be90">
  <div class="u-clearfix u-sheet u-sheet-1">
    <div class="u-form u-form-1">
      <form action="" method="POST"  enctype="multipart/form-data" class="u-clearfix u-form-spacing-15  u-inner-form" style="padding: 15px;" source="custom" name="form">
        ...
        <div class="u-form-group u-form-group-3">
          <label for="text-4036" class="u-form-control-hidden u-label"></label>
          <input type="text" placeholder="Price" id="text-4036" name="price" class="u-border-1 u-border-grey-30 u-input u-input-rectangle">
        </div>
        <div class="u-form-group u-form-message u-form-group-4">
          <label for="message-6797" class="u-form-control-hidden u-label">Address</label>
          <textarea placeholder="Info 1" rows="4" cols="50" id="message-6797" name="info1" class="u-border-1 u-border-grey-30 u-input u-input-rectangle ckeditor" required=""></textarea>
        </div>
        <div class="u-form-group u-form-group-5">
          <label for="textarea-4d67" class="u-form-control-hidden u-label"></label>
          <textarea placeholder="Info 2" rows="4" cols="50" id="textarea-4d67" name="info2" class="u-border-1 u-border-grey-30 u-input u-input-rectangle ckeditor" required="required"></textarea>
        </div>
        <div class="u-align-left u-form-group u-form-submit u-form-group-6">
          <input type="submit" name="submit" value="submit" class="u-btn u-btn-submit u-button-style u-gradient u-none u-btn-1">
        </div>
        <div class="u-form-send-message u-form-send-success">Thank you! Your message has been sent.</div>
        <div class="u-form-send-error u-form-send-message">Unable to send your message. Please fix errors then try again.</div>
        <input type="hidden" value="" name="recaptchaResponse">
...
<section class="u-align-center u-clearfix u-grey-10 u-section-3" id="sec-885b">
  <div class="u-clearfix u-sheet u-sheet-1">
      ...
      <table class="u-table-entity u-table-entity-1">
        ...
        <thead class="u-black u-table-header u-table-header-1">
          <tr style="height: 70px;">
            <th class="u-border-1 u-border-black u-gradient u-table-cell u-table-cell-1">Image</th>
            <th class="u-border-1 u-border-black u-gradient u-table-cell u-table-cell-3">Price</th>
            <th class="u-border-1 u-border-black u-gradient u-table-cell u-table-cell-2">Title</th>
            <th class="u-border-1 u-border-black u-gradient u-table-cell u-table-cell-4">Info 1</th>
            <th class="u-border-1 u-border-black u-gradient u-table-cell u-table-cell-4">Info 2</th>
        ...
        $no = 1;
        $sqluser = "SELECT * FROM tb_travel2 ORDER BY dte DESC LIMIT $posisi, $batas";
        $sqldata = mysqli_query($mysqli, $sqluser) or die (mysqli_error($mysqli));
        $queryJml ="SELECT * FROM tb_travel2";
        $no = $posisi + 1;
          ...
          { 
            ...
            <tbody class="u-table-body">
              <tr style="height: 83px;">
                ...
                <td class="u-border-1 u-border-grey-30 u-table-cell"><?=$datauser['price']?></td>
                <td class="u-border-1 u-border-grey-30 u-table-cell"><?=$datauser['title']?></td>
                <td class="u-border-1 u-border-grey-30 u-table-cell"><?=$datauser['info1']?></td>
                <td class="u-border-1 u-border-grey-30 u-table-cell"><?=$datauser['info2']?></td>
                <td class="u-border-1 u-border-grey-30 u-table-cell"><a href="edittravel.php?id=<?=$datauser['idtravel']?>" class="u-btn u-btn-submit u-button-style u-gradient u-none u-btn-1"><span class="u-file-icon u-icon u-icon-1"><img src="images/edit.png" alt=""></span></a><a onClick="return confirm('Apakah Anda Yakin Ingin Menghapus?')" href="m4.php?id=<?=$datauser['idtravel']?>" class="u-btn u-btn-submit u-button-style u-gradient u-none u-btn-1"><span class="u-file-icon u-icon u-icon-2"><img src="images/delete.png" alt=""></span></a>
                </td>
              </tr>
            </tbody>
            <?php
...
if(isset($_POST['edit'])){
  ...
  $info3 = trim(mysqli_real_escape_string($mysqli, $_POST['info3']));
  ...
  if (move_uploaded_file($jbt, $path)) {
    # code...
    mysqli_query($mysqli, "UPDATE tb_travel1 SET image = '$mmk', info1 = '$info1', info2 = '$info2', info3 = '$info3' WHERE id = '0'") or die (myqli_error($mysqli)) ;
    echo "<script>alert('Data berhasil di ubah!');window.location='crudtravel.php';</script>";
  ...
  $price = trim(mysqli_real_escape_string($mysqli, $_POST['price']));
  $info1 = trim(mysqli_real_escape_string($mysqli, $_POST['info1']));
  $info2 = trim(mysqli_real_escape_string($mysqli, $_POST['info2']));
  $mmk = $_FILES['image']['name'];
  $jbt = $_FILES['image']['tmp_name'];
  ...
  if (move_uploaded_file($jbt, $path)) {
    # code...
    mysqli_query($mysqli, "INSERT INTO tb_travel2  (idtravel, image, info1, info2, title, price, dte) VALUES ('$uuid', '$mmk', '$info1', '$info2', '$title', '$price', '$tgl')") or die (myqli_error($mysqli)) ;
    echo "<script>alert('Data berhasil di tambahkan!');window.location='crudtravel.php';</script>";
  }
}
?>