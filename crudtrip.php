...
if(isset($_SESSION['user'])){
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?=base_url()?>/css/Page-trip-crud.css" media="screen">
    ...
    <meta property="og:title" content="Page trip crud">
...
<?php 
$sqluser = mysqli_query($mysqli,"SELECT * FROM tb_trip1 ") or die (mysqli_error($mysqli));
...
<section class="u-align-center u-clearfix u-grey-10 u-section-1" id="sec-e1f0">
  <div class="u-clearfix u-sheet u-sheet-1">
    ...
    <h1 class="u-custom-font u-font-arial u-text u-text-1">Upload Trip</h1>
    <div class="u-form u-form-1">
      <form action="" enctype="multipart/form-data" method="POST" class="u-clearfix u-form-spacing-15 u-inner-form" style="padding: 15px;" source="custom" name="form">
        <div class="u-form-group u-form-group-1">
          ...
          <input type="file" placeholder="Image" id="email-6797" name="image" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="required" autofocus="autofocus">
        </div>
        <div class="u-form-group u-form-message u-form-group-2">
          ...
          <textarea placeholder="Trip" rows="4" cols="50" id="message-6797" name="info1" class="u-border-1 u-border-grey-30 u-input u-input-rectangle ckeditor" required=""><?=$datauser['info1']?></textarea>
        </div>
    ...
    <div class="u-form u-form-1">
      <form action="" method="POST" enctype="multipart/form-data" class="u-clearfix u-form-spacing-15 u-inner-form" style="padding: 15px;" source="custom" name="form">
        ...
        <div class="u-align-left u-form-group u-form-submit u-form-group-6">
          <input type="submit" value="Submit" name="submit" class="u-btn u-btn-submit u-button-style u-gradient u-none u-btn-1">
        </div>
        <div class="u-form-send-message u-form-send-success">Thank you! Your message has been sent.</div>
        <div class="u-form-send-error u-form-send-message">Unable to send your message. Please fix errors then try again.</div>
        <input type="hidden" value="" name="recaptchaResponse">
  ...
  <div class="u-clearfix u-sheet u-sheet-1">
    <div class="u-expanded-width u-table u-table-responsive u-table-1">
      <table class="u-table-entity u-table-entity-1">
        ...
        $no = 1;
        $sqluser = "SELECT * FROM tb_trip2 ORDER BY dte DESC LIMIT $posisi, $batas";
        $sqldata = mysqli_query($mysqli, $sqluser) or die (mysqli_error($mysqli));
        $queryJml ="SELECT * FROM tb_trip2";
        $no = $posisi + 1;
          ...
          { 
            ...
            <tbody class="u-table-body">
              <tr style="height: 83px;">
                ...
                <td class="u-border-1 u-border-grey-30 u-table-cell"><a href="edittrip.php?id=<?=$datauser['idtrip']?>" class="u-btn u-btn-submit u-button-style u-gradient u-none u-btn-1"><span class="u-file-icon u-icon u-icon-1"><img src="images/edit.png" alt=""></span></a><a onClick="return confirm('Apakah Anda Yakin Ingin Menghapus?')" href="m3.php?id=<?=$datauser['idtrip']?>" class="u-btn u-btn-submit u-button-style u-gradient u-none u-btn-1"><span class="u-file-icon u-icon u-icon-2"><img src="images/delete.png" alt=""></span></a>
                </td>
              </tr>
            </tbody>
            <?php
...
if(isset($_POST['edit'])){
  ...
  if (move_uploaded_file($jbt, $path)) {
    # code...
    mysqli_query($mysqli, "UPDATE tb_trip1 SET image = '$mmk', info1 = '$info1', info2 = '$info2', info3 = '$info3' WHERE id = '0'") or die (myqli_error($mysqli)) ;
    echo "<script>alert('Data berhasil di ubah!');window.location='crudtrip.php';</script>";
  ...
  if (move_uploaded_file($jbt, $path)) {
    # code...
    mysqli_query($mysqli, "INSERT INTO tb_trip2  (idtrip, image, info1, info2, title, price, dte) VALUES ('$uuid', '$mmk', '$info1', '$info2', '$title', '$price', '$tgl')") or die (myqli_error($mysqli)) ;
    echo "<script>alert('Data berhasil di tambahkan!');window.location='crudtrip.php';</script>";
  }
}
?>