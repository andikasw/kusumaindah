...
<head>
  ...
  <link rel="stylesheet" href="<?=base_url()?>/css/Page-news.css" media="screen">
  ...
  <meta property="og:title" content="Page news">
...
<?php 
$id = @$_GET['id'];
$sqluser = mysqli_query($mysqli,"SELECT * FROM tb_news WHERE idnews = '$id' ") or die (mysqli_error($mysqli));
$datauser = mysqli_fetch_array($sqluser);
?> 
<section class="u-clearfix u-grey-10 u-section-1" id="sec-9c3e">
  <div class="u-clearfix u-sheet u-sheet-1">
    ...
    <h1 class="u-custom-font u-font-arial u-text u-title u-text-1">News</h1>
        ...
        while($datauser = mysqli_fetch_array($sqluser))
        {
          ...
          <div class="u-container-style u-list-item u-repeater-item">
            <div class="u-container-layout u-similar-container u-container-layout-1">
             ...
             ?>
             <h3 class="u-custom-font u-font-arial u-text u-text-1"><?=$cetak1, $e1?></h3>
             ...
             ?>
             <p class="u-text u-text-2"><?=$cetak , $e?></p>
              <a href="pagenews.php?id=<?=$datauser['idnews']?>" class="u-btn u-button-style u-gradient u-hover-palette-1-dark-1 u-none u-btn-1">learn more</a>
            </div>
        </div>
          <?php }} ?>
        </div>
      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-align-left u-container-style u-group u-shape-rectangle u-group-1">
          <div class="u-container-layout u-container-layout-1">
            ...
            <p class="u-large-text u-text u-text-body-alt-color u-text-variant u-text-2">F<?=$datauser['info2']?></p>
