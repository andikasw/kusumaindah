    ...
    <div class="u-form u-form-1">
     <form action=""  enctype="multipart/form-data" method="post" class="u-clearfix u-form-spacing-15  u-inner-form" style="padding: 15px;" source="custom" name="form">
      <div class="u-form-group u-form-group-1">
        ...
        <input type="file" placeholder="" id="email-6797" name="image1" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="">
      </div>
      <div class="u-align-left u-form-group u-form-submit u-form-group-3">
        <input type="submit" value="Submit" class="u-btn u-btn-submit u-button-style u-gradient u-none u-btn-1" name="gas1">
      </div>
      ...
      <div class="u-form-group u-form-group-1">
        <label for="email-6797" class="u-form-control-hidden u-label"></label>
        <input type="file" placeholder="" id="email-6797" name="image2" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="">
      </div>
      <div class="u-align-left u-form-group u-form-submit u-form-group-3">
        <input type="submit" value="Submit" class="u-btn u-btn-submit u-button-style u-gradient u-none u-btn-1" name="gas2">
      </div>
      <div class="u-form-send-message u-form-send-success">Thank you! Your message has been sent.</div>
      <div class="u-form-send-error u-form-send-message">Unable to send your message. Please fix errors then try again.</div>
      <!-- <input type="hidden" value="" name="recaptchaResponse"> -->
...
<!--          <form action=""  enctype="multipart/form-data" method="post" class="u-clearfix u-form-spacing-15  u-inner-form" style="padding: 15px;" source="custom" name="form">
      <div class="u-form-group u-form-group-1">
        <label for="email-6797" class="u-form-control-hidden u-label"></label>
        <input type="file" placeholder="" id="email-6797" name="image3" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="">
      </div>
      <div class="u-align-left u-form-group u-form-submit u-form-group-3">
        <input type="submit" value="Submit" class="u-btn u-btn-submit u-button-style u-gradient u-none u-btn-1" name="gas3">
      </div>
      <div class="u-form-send-message u-form-send-success">Thank you! Your message has been sent.</div>
      <div class="u-form-send-error u-form-send-message">Unable to send your message. Please fix errors then try again.</div>
    </form> -->
    <form action=""  enctype="multipart/form-data" method="post" class="u-clearfix u-form-spacing-15  u-inner-form" style="padding: 15px;" source="custom" name="form">
      <div class="u-form-group u-form-group-1">
        <label for="email-6797" class="u-form-control-hidden u-label"></label>
        <input type="file" placeholder="" id="email-6797" name="image" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="">
      </div>
      <div class="u-form-group u-form-message u-form-group-2">
        ...
        <textarea placeholder="" rows="4" cols="50" id="essmage-6797" name="info" class="u-border-1 u-border-grey-30 u-input u-input-rectangle " required=""><?=$datauser['info']?></textarea>
      </div>
      <div class="u-align-left u-form-group u-form-submit u-form-group-3">
...
<section class="u-align-center u-clearfix u-grey-10 u-valign-top-xs u-section-2" id="sec-b83e">
      ...
      <div class="u-layout-row">
        <div class="u-container-style u-layout-cell u-size-30 u-layout-cell-1">
          <div class="u-container-layout u-valign-middle-md u-valign-top-lg u-valign-top-xl u-container-layout-2">
            <img src='view/<?=$datauser['gambar']?>' alt="" class="u-expanded-width u-image u-image-default u-image-1" data-image-width="1280" data-image-height="853">
          </div>
        </div>
        <div class="u-container-style u-layout-cell u-size-30 u-layout-cell-2">
          <div class="u-container-layout u-valign-top-lg u-valign-top-md u-valign-top-sm u-valign-top-xl u-container-layout-3">
            <h2 class="u-align-left u-custom-font u-font-playfair-display u-text u-text-1">about us</h2>
...
if(isset($_POST['mlebu'])){
  $tgl = date("Y-m-d H:i:s");
    ...
    // $foto = trim(mysqli_real_escape_string($mysqli, $_POST['image']));
  ...
  if (move_uploaded_file($jbt, $path)) {
    ...
    echo "<script>alert('Data berhasil di ubah!');window.location='crudprofil.php';</script>";
        // $sqli = mysqli_query($mysqli, "INSERT INTO profil (gambar, info, tanggal) VALUES ('$mmk', '$info', '$tgl')");
        // echo "<script>alert('Data berhasil di tambahkan!');window.location='crudprofil.php';</script>";
  }
}if(isset($_POST['gas1'])){
  $tgl = date("Y-m-d H:i:s");


  $mmk1 = $_FILES['image1']['name'];
  $jbt1 = $_FILES['image1']['tmp_name'];
  $path1 = "view/".$mmk1;  

  if (move_uploaded_file($jbt1, $path1)) {
    # code...
    mysqli_query($mysqli, "UPDATE profil SET gambar1 = '$mmk1' WHERE id = '1'") or die (myqli_error($mysqli)) ;
    echo "<script>alert('Data berhasil di ubah!');window.location='crudprofil.php';</script>";
  }
}if(isset($_POST['gas2'])){
  $tgl = date("Y-m-d H:i:s");

  $mmk2 = $_FILES['image2']['name'];
  $jbt2 = $_FILES['image2']['tmp_name'];
  $path2 = "view/".$mmk2;  

  if (move_uploaded_file($jbt2, $path2)) {
    # code...
    mysqli_query($mysqli, "UPDATE profil SET gambar2 = '$mmk2' WHERE id = '2'") or die (myqli_error($mysqli)) ;
    echo "<script>alert('Data berhasil di ubah!');window.location='crudprofil.php';</script>";
  }
}
// if(isset($_POST['gas3'])){
...
//   $path2 = "view/".$mmk3;  
//   $mmk3 = $_FILES['image3']['name'];
//   $jbt3 = $_FILES['image3']['tmp_name'];
//   $path3 = "view/".$mmk3;

//   if (move_uploaded_file($jbt3, $path3)) {
//     # code...
//     mysqli_query($mysqli, "UPDATE profil SET gambar3 = '$mmk3' WHERE id = '3'") or die (myqli_error($mysqli)) ;
//     echo "<script>alert('Data berhasil di ubah!');window.location='crudprofil.php';</script>";
//   }
// }
?>