...
<?php 
$id = @$_GET['id'];
$sqluser = mysqli_query($mysqli,"SELECT * FROM tb_mice1 WHERE idmice = '$id' ") or die (mysqli_error($mysqli));
    ...
    <div class="u-form u-form-1">
      <form action="" method="POST"  enctype="multipart/form-data" class="u-clearfix u-form-spacing-15  u-inner-form" style="padding: 15px;" source="custom" name="form">
        ...
        <div class="u-form-group u-form-group-3">
          ...
          <input type="text" placeholder="Price" value="<?=$datauser['price']?>" id="text-4036" name="price" class="u-border-1 u-border-grey-30 u-input u-input-rectangle">
        </div>
...
if(isset($_POST['edit'])){
  ...
  if (move_uploaded_file($jbt, $path)) {
    # code...
    mysqli_query($mysqli, "UPDATE tb_mice1 SET image = '$mmk', title = '$title', price = '$price', info1 = '$info1', info2 = '$info2' WHERE idmice = '$id'") or die (myqli_error($mysqli)) ;
