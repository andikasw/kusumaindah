...
if(isset($_SESSION['user'])){
  ...
  <head>
    ...
    <title>Edit Travel Reguler</title>    
...
<?php 
$id = @$_GET['id'];
$sqluser = mysqli_query($mysqli,"SELECT * FROM tb_travel2 WHERE idtravel = '$id' ") or die (mysqli_error($mysqli));
    ...
    <div class="u-form u-form-1">
      <form action="" method="POST"  enctype="multipart/form-data" class="u-clearfix u-form-spacing-15  u-inner-form" style="padding: 15px;" source="custom" name="form">
        <div class="u-form-group u-form-name u-form-group-1">
          ...
          <input type="text" placeholder="Title" id="name-6797" value="<?=$datauser['title']?>" name="title" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="" >
        </div>
        ...
        <div class="u-form-group u-form-group-3">
          ...
          <input type="text" placeholder="Price" id="text-4036" value="<?=$datauser['price']?>" name="price" class="u-border-1 u-border-grey-30 u-input u-input-rectangle">
        </div>
        <div class="u-form-group u-form-message u-form-group-4">
          ...
          <textarea placeholder="Info 1" rows="4" cols="50" id="message-6797" name="info1" class="u-border-1 u-border-grey-30 u-input u-input-rectangle ckeditor" required=""><?=$datauser['info1']?></textarea>
        </div>
        <div class="u-form-group u-form-group-5">
          <label for="textarea-4d67" class="u-form-control-hidden u-label"></label>
          <textarea placeholder="Info 2" rows="4" cols="50" id="textarea-4d67" name="info2" class="u-border-1 u-border-grey-30 u-input u-input-rectangle ckeditor" required="required"><?=$datauser['info2']?></textarea>
        </div>
        <div class="u-align-left u-form-group u-form-submit u-form-group-6">
          <input type="submit" name="edit" value="Submit" class="u-btn u-btn-submit u-button-style u-gradient u-none u-btn-1">
        </div>
...
if(isset($_POST['edit'])){
  ...
  if (move_uploaded_file($jbt, $path)) {
    # code...
    mysqli_query($mysqli, "UPDATE tb_travel2 SET image = '$mmk', title = '$title', price = '$price', info1 = '$info1', info2 = '$info2' WHERE idtravel = '$id'") or die (myqli_error($mysqli)) ;
